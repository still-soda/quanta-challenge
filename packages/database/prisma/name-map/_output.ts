...
export const schemaToRealMap = {
   ...
   "UserSpaceConfig": "user_space_configs",
...
export const realToSchemaMap = {
   ...
   "user_space_configs": "UserSpaceConfig",
   "notifications": "Notification"
} as const;

export const validRealNames = ["users","user_infos","role_transitions","auths","webauthn_credentials","images","user_images","base_problems","problems","problem_version_transitions","problem_default_covers","audit_records","status_transitions","template_judge_records","judge_status","judge_records","judge_files","tags","file_systems","projects","virtual_files","shadow_files","daily_problems","daily_checkins","achievements","achievement_pre_achievements","checkin_achievements","achievement_dependency_data_request_records","achievement_dependency_data","achievement_validate_scripts","achievement_dep_data_loaders","user_achievements","user_statistics","ranking_histories","user_settings","user_space_configs","notifications"] as const;

export const realNameFieldsMap = {
   "users": new Set(["id","role","name","email","displayName","imageId","createdAt","updatedAt","lastLogin","score","avatar","auths","WebAuthnCredential","StatusTransitions","Tag","FileSystem","VirtualFile","Project","RoleTransition","UserImage","JudgeRecord","BaseProblems","ProblemVersionTransitions","DailyCheckin","UserAchievement","Achievement","UserStatistic","RankingHistory","UserSettings","UserInfo","UserSpaceConfig","notifications"] as const),
   "user_infos": new Set(["id","userId","bio","email","major","identifier","birthday","bannerImageId","createdAt","updatedAt","user","bannerImage"] as const),
   ...
   "images": new Set(["id","name","thumbhash","createdAt","updatedAt","refCount","User","Tag","ShadowFile","ProblemDefaultCover","UserImage","Problem","Achievement","UserInfo"] as const),
   ...
   "problems": new Set(["pid","baseId","title","detail","isDeprecated","difficulty","totalScore","status","createdAt","updatedAt","coverImageId","bootCommand","initCommand","buildCommand","judgeUploadPath","tags","AuditRecord","StatusTransitions","JudgeFile","Project","ProblemDefaultCover","JudgeRecord","TemplateJudgeRecord","CoverImage","BaseProblem","CurrentOfBase","ProblemVersionTransitions","ProblemVersionTransitionsTo","JudgeStatus"] as const),
   ...
   "achievements": new Set(["id","name","description","badgeImageId","createdAt","updatedAt","authorId","score","author","badgeImage","UserAchievement","AchievementDependencyData","AchievementValidateScript","CheckinAchievement","AchievementPreAchievement","AchievementPreAchievementAsPre"] as const),
...
export const nestedModelMapping = {
   "User": {
      ...
      "UserInfo": "UserInfo:Single:Optional",
      "UserSpaceConfig": "UserSpaceConfig:Single:Optional",
      "notifications": "Notification:List:Required"
   },
   "UserInfo": {
      "user": "User:Single:Required",
      "bannerImage": "Image:Single:Optional"
   },
   "RoleTransition": {
      "user": "User:Single:Required"
   },
   ...
   "Image": {
      ...
      "Achievement": "Achievement:List:Required",
      "UserInfo": "UserInfo:List:Required"
   },
   "UserImage": {
      "user": "User:Single:Required",
