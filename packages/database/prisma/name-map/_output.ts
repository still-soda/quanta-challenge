...
export const validRealNames = ["users","role_transitions","auths","webauthn_credentials","images","user_images","base_problems","problems","problem_version_transitions","problem_default_covers","audit_records","status_transitions","template_judge_records","judge_status","judge_records","judge_files","tags","file_systems","projects","virtual_files","shadow_files","daily_problems","daily_checkins","achievements","checkin_achievements","achievement_dependency_data_request_records","achievement_dependency_data","achievement_validate_scripts","achievement_dep_data_loaders","user_achievements","user_statistics","ranking_histories"] as const;

export const realNameFieldsMap = {
   "users": new Set(["id","role","email","name","imageId","createdAt","updatedAt","lastLogin","avatar","auths","WebAuthnCredential","StatusTransitions","Tag","FileSystem","VirtualFile","Project","RoleTransition","UserImage","JudgeRecord","BaseProblems","ProblemVersionTransitions","DailyCheckin","UserAchievement","Achievement","UserStatistic","RankingHistory"] as const),
   ...
   "achievements": new Set(["id","name","description","badgeImageId","createdAt","updatedAt","authorId","author","badgeImage","UserAchievement","AchievementDependencyData","AchievementValidateScript","CheckinAchievement"] as const),
