...
export const realNameFieldsMap = {
   "users": new Set(["id","role","email","name","imageId","createdAt","updatedAt","lastLogin","avatar","auths","WebAuthnCredential","StatusTransitions","Tag","FileSystem","VirtualFile","Project","RoleTransition","UserImage","JudgeRecord","BaseProblems","ProblemVersionTransitions","DailyCheckin","UserAchievement","Achievement"] as const),
